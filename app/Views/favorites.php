<?php
// Pastikan session dimulai dan data produk di-load
...
// Ambil detail produk favorit
$favoriteProducts = [];
// Asumsi fungsi getProductById ada di data.php, jika tidak, lakukan looping di bawah ini
foreach ($favoriteIds as $id) {
  // Cari detail produk berdasarkan ID (harus ada di data.php)
        ...
        ?>
          <a href="product_detail.php?id=<?php echo $productId; ?>"
            ...
            <button
              ...
              class="absolute top-2 right-2 p-1.5 rounded-full shadow-md transition duration-300 z-10 bg-red-500 text-white hover:bg-gray-600">
  ...
  <script>
    function removeFromFavorites(productId) {
      if (confirm('Yakin ingin menghapus produk ini dari favorit?')) {
        // Menggunakan path relatif 'handle_favorite.php' karena di root
